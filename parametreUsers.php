...
<body class="bg-[burlywood]">
        ...
        <div class="partieDroite w-[calc(100vw_-_80px)] mt-[55px] p-[10px] overflow-y-auto h-[70vh]">
            ...
            <table class="w-full border-spacing-0">
                <thead class="bg-[coral] font-[bolder]">
                    <td class="border p-2.5 border-solid border-[black]">Nom utilisateur</td>
                ...
                <tr>
                    <td class="border p-2.5 border-solid border-[black]">Username 1</td>
                    <td class="border p-2.5 border-solid border-[black]">mon email@email.com</td>
    ...
    <form class="editerUtilisateurForm hidden w-[360px] bg-[linear-gradient(45deg,burlywood,chocolate)] absolute left-[calc(50%_-_180px)] p-2.5 rounded-[10px] top-[200px]" action="" method="POST">

        <label for="titre">Nom utilisateur :</label>
        <input class="w-full" name="usernameAModifier" id="titre" type="text">
